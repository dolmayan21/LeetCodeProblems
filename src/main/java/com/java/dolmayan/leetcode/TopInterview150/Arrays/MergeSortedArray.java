...
public class MergeSortedArray {
    ...
    * sorted in non-decreasing order.The final sorted array
    * should not be returned by the function, but instead be
    * stored inside the array nums1. To accommodate this, nums1
    *  has a length of m + n, where the first m elements denote
